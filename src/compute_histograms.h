...
ComputeStyle(histograms,ComputeHISTOGRAMS)

#else

#ifndef LMP_COMPUTE_HISTOGRAMS_H
#define LMP_COMPUTE_HISTOGRAMS_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeHISTOGRAMS : public Compute {
 public:
  ComputeHISTOGRAMS(class LAMMPS *, int, char **);
  ~ComputeHISTOGRAMS();
  void init();
 ...
 private:
  ...
  int num_observables;   // # of observables NOT including coord(r)
