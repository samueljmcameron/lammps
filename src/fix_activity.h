...
FixStyle(activity,FixActivity)

#else

#ifndef LMP_FIX_ACTIVITY_H
#define LMP_FIX_ACTIVITY_H

#include "fix.h"

namespace LAMMPS_NS {

class FixActivity : public Fix {
 public:
  FixActivity(class LAMMPS *, int, char **);
  virtual ~FixActivity();
  int setmask();
  void init();
  void setup(int);
...
E: Cannot zero Activity force of 0 atoms
