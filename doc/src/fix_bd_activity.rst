.. index:: fix bd/activity

fix bd/activity command
====================
...
.. parsed-literal::
   ...
   fix ID group-ID bd/activity v0 Dt gamma Dr seed keyword values ...

* ID, group-ID are documented in :doc:`fix <fix>` command
* bd/activity = style name of this fix command
* v0 = self-propulsion speed of particles
* Dt = translational diffusion (length^2/time units)
* gamma = damping parameter (mass/time units)
* Dr = rotational diffusion (1/time units)
