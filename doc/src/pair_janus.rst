.. index:: pair_style janus/cut

pair_style janus/cut command
====================================
...
.. code-block:: LAMMPS
   ...
   pair_style janus/cut md sd mbfx mbfy mbfz sbfx sbfy sbfz d ux uy uz fixed_orientation self_interacting cutoff 

* md = magnitude of metal dipole
* sd = magnitude of silica dipole
* mbfx,mbfy,mbfz = orientation of metal dipole in body frame (will normalise automatically)
* sbfx,sbfy,sbfz = orientation of silica dipole in body frame (will normalise automatically)
* d = half the distance between dipoles
* ux,uy,uz = orientation of (unit) vector connecting dipoles
* fixed_orientation = whether the metal and silica dipoles rotate with particles (if true, then body frames for metal and silica are lab frames always)
* self_interacting = whether self-interactions are included (true or false)
* cutoff = global cutoff of interaction (distance units)




!!!!!! from this point forward, the documentation is just a copy paste of pair_dipole doc !!!!!
